...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    className={cn('fixed inset-0 z-50 bg-black/80 backdrop-blur-sm data-[state=open]:animate-in', className)}
    {...props}
    ref={ref}
  />
));
...
>(({ side = 'right', className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 gap-4 bg-pizarra text-white shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out',
